import { AddQuoteResponseDto, AddTagResponseDto, GetAllQuotesResponseDto, GetAllTagsResponseDto, UpdateQuoteRequestDto, UpdateQuoteResponseDto } from "@cnbc-monorepo/dtos";
