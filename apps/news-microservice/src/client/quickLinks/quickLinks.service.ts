import {
  ...
  AddQuickLinksResponseDto,
  DeleteQuickLinkRequestDto,
  GenericResponseDto,
  GetAllQuickLinksResponseDto,
  GetQuickLinkByIdResponseDto,
  PaginatedRequestDto,
  UpdateQuickLinksRequestDto,
  UpdateQuickLinksResponsDto,
...
export class QuickLinksService {
  ...
  async getAllQuickLinks(query: PaginatedRequestDto) {
    ...
    return new GetAllQuickLinksResponseDto(
      HttpStatus.OK,
      'FETCHED SUCCESSFULLY',
      result.map((e: QuickLinks) => {
        return { title: e.title, url: e.url } as any;
      })
    );
  }
  ...
  async getById(id: number) {
    ...
    return new GetQuickLinkByIdResponseDto(
      HttpStatus.OK,
      'FETCHED SUCCESSFULLY',
      result
    );
