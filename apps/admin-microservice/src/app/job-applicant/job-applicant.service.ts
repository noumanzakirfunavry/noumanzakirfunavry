...
export class JobApplicantService {
    ...
    async getAllJobApplicants(query: GetAllJobApplicantsRequestDto): Promise<GenericResponseDto> {
        try {
            ...
            console.log("🚀 ~ file: job-applicant.service.ts ~ line 28 ~ JobApplicantService ~ getAllJobApplicants ~ err", err)
            throw err
        }
    ...
    async getJobApplicantById(id: number): Promise<GenericResponseDto> {
        try {
            ...
            console.log("🚀 ~ file: job-applicant.service.ts ~ line 42 ~ JobApplicantService ~ getJobApplicantById ~ err", err)
            throw err
        }
