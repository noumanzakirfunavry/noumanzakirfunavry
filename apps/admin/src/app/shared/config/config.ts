...
export const requests = {
    login: 'http://localhost:3333/api/authentication/login',
    ...
    addNewTag: 'http://localhost:3333/api/tags',
    updateTag: 'http://localhost:3333/api/tag/',
    getAllTags: 'http://localhost:3333/api/tagsAll',
    getTagById: 'http://localhost:3333/api/tags/',
    deleteTags: 'http://localhost:3333/api/tags/',
    addNewQuote: 'http://localhost:3333/api/quote',
    updateQuote: 'http://localhost:3333/api/quote',
    getAllQuotes: 'http://localhost:3333/api/quotes',
    ...
    addNewQuickLink: 'http://localhost:3333/api/admin/quickLinks',
    updateQuickLink: 'http://localhost:3333/api/admin/quickLinks/',
    getAllQuickLinks: 'http://localhost:3333/api/admin/quickLinks',
    getQuickLinkById: 'http://localhost:3333/api/admin/quickLinks/',
    deleteQuickLink: 'http://localhost:3333/api/admin/quickLinks/',
    ...
    getAllCategories: 'http://localhost:3333/api/admin/categoriesAll',
    getCategoryById: 'http://localhost:3333/api/admin/categories/',
    deleteCategories: 'http://localhost:3333/api/admin/categories/',
    addCategory: 'http://localhost:3333/api/admin/categories',
    updateCategory: 'http://localhost:3333/api/admin/categories/',
