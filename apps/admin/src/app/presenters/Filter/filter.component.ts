...
export class FilterComponent {
    ...
    filterModel : {isActive: boolean, title: string, publisher: number} = {isActive: null, title: null, publisher: null}
    ...
    clear() {
        this.filterModel= { isActive : null, title : null, publisher: null};
