...
export class FilterComponent {
    ...
    filterModel : {isActive: boolean, title: string, publishers: Array<any>} = {isActive: null, title: null, publishers: null}
    ...
    clear() {
        this.filterModel= { isActive : null, title : null, publishers: null};
